    ...
    <div className="w-full">
      ...
      <div className="fixed bg-white z-50 h-20 w-full border-b flex justify-around items-center">
        <div className="flex items-center">
          ...
          <h1 className="font-bold mt-3 text-xl">Apni Dukaan</h1>
        </div>
        <button className="btn btn-wide">Start For Free</button>
      </div>

      <div className="w-9/12 mx-auto flex min-h-screen justify-center items-center">
        <div className="w-1/2 flex flex-col justify-center items-start p-6">
          <h1 className="text-6xl font-bold max-w-lg">Start
            selling
            online.</h1>
      ...
      <div className="flex justify-center items-center">
        <div className="min-h-screen w-8/12 my-24">
          <h1 className="text-3xl font-bold">Your dream business just three steps away!</h1>
          <div className="flex mt-16 items-center justify-between gap-10">
            <div className="w-1/2">
